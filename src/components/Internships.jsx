  ...
  >
    <div>
      <div className="flex justify-between items-start mb-6">
        ...
        <span className={`text-[10px] font-black tracking-widest uppercase py-1 px-3 rounded-full border ${
          intern.isCurrent
            ? 'bg-white/25 text-white border-white/50 shadow-[0_0_12px_rgba(255,255,255,0.3)]'
            : 'bg-white/10 text-white/90 border-white/20'
        }`}>
          {intern.badge || (intern.isCurrent ? "Current Professional Experience" : "Professional Role")}
        </span>
      </div>
      <h3 className="text-white text-2xl font-black mb-1 tracking-tight">
        {intern.role}
      </h3>
      <p className="text-white/90 text-sm font-black tracking-wide mb-6 uppercase">
        {intern.organization}
      </p>
      ...
      <div className="mb-6">
        ...
        <ul className="text-white/95 text-sm font-medium space-y-1 pl-4 list-disc">
    ...
    <div className="pt-4 border-t border-white/15">
      ...
      <div className="flex flex-wrap gap-2">
        {intern.tech.map((t) => (
          <span 
            key={t}
            className="px-3 py-1 text-xs font-mono font-bold text-white bg-white/15 rounded-full border border-white/20 hover:bg-white/30 transition-all"
          >
            {t}
          </span>
        ))}
...
const Internships = () => {
  return (
    <section className="bg-[#1d4ed8] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-blue-100 text-base md:text-lg font-semibold max-w-xl mx-auto">
            Professional experience and engineering projects applying proven methodologies and building real-world assets.
          </p>
        </div>
