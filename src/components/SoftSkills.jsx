...
const SoftSkillCard = ({ skill, index }) => (
  <div 
    ...
    className="bg-[#f8f8f8] border border-gray-200 rounded-3xl p-6 hover:scale-[1.03] hover:bg-white hover:border-[#4F7CFF]/30 hover:shadow-[0_20px_45px_rgba(79,124,255,0.12)] transition-all duration-500 group flex flex-col items-center text-center justify-between min-h-[220px]"
  >
    <div className="flex flex-col items-center">
      <div className="text-4xl mb-4 p-3 bg-gray-100 rounded-2xl group-hover:bg-[#4F7CFF]/10 group-hover:scale-110 transition-all duration-300">
        {skill.icon}
      </div>
...
const SoftSkills = () => {
  return (
    <section className="bg-white pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#80808006_1px,transparent_1px),linear-gradient(to_bottom,#80808006_1px,transparent_1px)] bg-[size:60px_60px]">
      ...
      {/* Top paper divider (torn SVG transition from blue Certificates section) */}
