...
const CertificateCard = ({ cert, aosDelay }) => (
  <a 
    ...
    className="bg-black/20 backdrop-blur-sm rounded-2xl p-5 border border-white/10 hover:border-white/30 hover:scale-105 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] transition-all duration-500 cursor-pointer group flex flex-col justify-between"
  >
    ...
    <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[11px] font-mono text-white/40 group-hover:text-white transition-colors">
...
const Certificates = () => {
  return (
    <section className="bg-[#1d4ed8] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-12 md:mb-16 text-center">
          ...
          <p className="text-blue-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            Official, verified credentials from industry simulations, government initiatives, and academic institutions.
          </p>
        </div>
      ...
      <div className="absolute bottom-20 right-8 md:right-24 text-white opacity-20 animate-pulse" style={{ animationDelay: '1.5s' }}>
